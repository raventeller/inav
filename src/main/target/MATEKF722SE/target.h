...
// *************** SPI1 Gyro & ACC *******************
// Keep descriptors active so target.c doesn't clash with the linker
...
// Force pin mappings directly over any automated defaults
...
// Reconfigure Physical I2C Bus 1 (Baro)
...
// Reconfigure Physical I2C Bus 2 (External Compass)
...
#define USE_MAG
#define MAG_I2C_BUS BUS_I2C2  // Routes external compass to I2C2 pins (B10/B11)
#define USE_MAG_ALL
...
//#define USE_MAX7456
#define OSD_HARDWARE_DEFAULT OSD_NONE
...
#else 
// Replaced SDCard macro with Flash chip configuration
# define USE_FLASHFS
# define USE_FLASH_M25P16
# define M25P16_SPI_BUS BUS_SPI3
